        ...
        <div className="bg-stone-50 min-h-full p-5">
            <header className="flex justify-between items-center mb-6 rtl:flex-row-reverse">
                ...
                <Link to="/profile" className="flex-shrink-0">
                     <img src="https://pngdownload.io/wp-content/uploads/2024/03/Male-user-avatar-icon-transparent-PNG-image-jpg.webp" alt="Profile" className="w-12 h-12 rounded-full object-cover" />
                </Link>
            </header>
